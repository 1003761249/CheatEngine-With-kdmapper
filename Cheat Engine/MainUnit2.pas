...
{$ifdef altname}  //i'd use $MACRO ON but fpc bugs out
  strCheatEngine='Deemo2 Engine'; //if you change this, also change it in first.pas
  strCheatTable='Code Table';   //because it contains code.... duh.....
  strCheatTableLower='code table';
  strCheat='Deemo2';
  strTrainer='Deemo2 Trainer';
  strTrainerLower='deemo2 trainer';
  strMyCheatTables='Deemo2 Tables';
  strSpeedHack='Deemo2 Speedchange';
{$else}
