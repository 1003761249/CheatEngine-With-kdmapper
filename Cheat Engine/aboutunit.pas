...
begin
  shellexecute(0,'open',pchar('https://space.bilibili.com/131403708'),nil,nil,sw_maximize);
end;

procedure TAbout.Label8Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://space.bilibili.com/131403708'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;
